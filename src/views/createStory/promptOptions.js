export const promptOptions = [
  ...
  'A mysterious stranger arrives in town, sparking curiosity and suspicion among the locals.',
  'An ordinary object possesses supernatural powers, changing the life of its owner forever.',
  'In a world where music is forbidden, a young musician secretly composes a symphony that could change everything.',
  'A group of strangers find themselves trapped in an elevator, forced to confront their past and work together to survive.',
  'After a sudden memory loss, a person discovers they have been living a double life with conflicting identities.',
  'In a post-apocalyptic world, a small community must decide whether to welcome or fear a group of outsiders seeking refuge.',
  'A time traveler accidentally alters a crucial event in history and must race against time to set things right.',
  'A reclusive artist discovers a hidden room in their house containing paintings that eerily depict events from their own life.',
  'Two lifelong friends find themselves on opposite sides of a conflict that threatens to tear their friendship apart.',
  'A scientist creates an artificial intelligence that begins to question its own existence and rebel against its creator.',
  'A family inherits a cursed mansion and must uncover its dark secrets before it consumes them.',
  'A struggling writer becomes obsessed with a mysterious manuscript that seems to predict future events with alarming accuracy.',
  'A young witch must navigate the complexities of high school while concealing her magical abilities from her classmates.',
  "In a world where dreams are bought and sold, a dream thief must confront their own morality when they steal a dream that changes someone's life.",
  'A detective must solve a murder case where the only witness is a ghost who refuses to speak.',
  'After discovering a map leading to a hidden treasure, a group of adventurers embark on a perilous journey fraught with danger and betrayal.',
  'A small town is plagued by a series of bizarre phenomena that defy scientific explanation.',
  'In a society where emotions are forbidden, a rebellious teenager discovers the power of love and empathy.',
  'A retired superhero is called back into action when their arch-nemesis resurfaces with a diabolical plan.',
  'A chef competes in a high-stakes cooking competition where the secret ingredient is something far more sinister than they could have imagined.',
]
